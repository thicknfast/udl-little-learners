...
### Predicting Barriers to Specials Classes
...
A few predictable barriers show up again and again across specialist spaces:
...
### UDL-Aligned Strategy: Codesign Structures and Routines

Barrier Addressed: Students move between many different adults and spaces over the course of a day, and inconsistent expectations, cues, and routines from room to room force them to relearn "how things work" over and over.
...
### UDL-Aligned Strategy: Support with Visuals

Barrier Addressed: Students aren't yet readers or are still developing language, so vocabulary, directions, and expectations delivered only through spoken words leave them without a way to access or retain them.
...
### UDL-Aligned Strategy: Support Directions and Procedures

Barrier Addressed: Students walk into your space infrequently, so routines and procedures that would be automatic in a homeroom classroom have to be re-taught and re-supported at every key moment of the period.
...
### UDL-Aligned Strategy: Support Language with Sentence Stems and Nonverbals

Barrier Addressed: Students' familiarity with you and your content varies widely from class to class, and without supports for expression, they lack a reliable way to communicate needs, ideas, or understanding.
...
### UDL-Aligned Strategy: Jobs and Roles

Barrier Addressed: Infrequent contact and long gaps between sessions (snow days, breaks, once-a-week schedules) mean routines and expectations don't stay fresh, and the burden of re-establishing them falls entirely on the teacher.
...
### UDL-Aligned Strategy: Create Multiple Pathways

Barrier Addressed: Students arrive with a wide range of skill levels, and a single way to follow directions, practice a skill, or demonstrate understanding leaves some learners without a way in.
...
### UDL-Aligned Strategy: Movement as Part of the Learning

Barrier Addressed: Students arrive at specials already needing to move after sitting for long stretches, and treating movement only as a break from learning wastes a chance to use it as a pathway to learning.
